...
const DEFAULT_ISBN_MAP = require( '../../node_modules/dlts-open-square-standard-identifiers/map-of-nonstandard-isbns-to-standard-isbns.json' );

function standardizeEpubIsbns( epubsDirectory, isbnMapArg ) {
    const isbnMap = isbnMapArg || DEFAULT_ISBN_MAP;
